...
exports.methods = [{ name: 'query', result: 'result' }, { name: 'select', result: 'rows' }, { name: 'one', result: 'one' }, { name: 'value', result: 'value' }, { name: 'insert', result: 'count' }, { name: 'update', result: 'count' }, { name: 'delete', result: 'count' }, { name: 'command', result: 'none' }];