...
[{ name: 'query', result: 'result' }, { name: 'select', result: 'rows' }, { name: 'selectOne', result: 'one' }, { name: 'selectValue', result: 'value' }, { name: 'insert', result: 'count' }, { name: 'update', result: 'count' }, { name: 'delete', result: 'count' }].forEach(function (o) {
